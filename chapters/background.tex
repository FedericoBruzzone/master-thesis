...
\begin{itemize}
    ...
    \item \textbf{MontiCore}\footnote{\url{https://www.monticore.de/}}~\cite{Rath19}: A language workbench for developing domain-specific languages and language families.
\end{itemize}
