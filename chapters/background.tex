...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\linewidth]{figs/FM/background_featuremodel.pdf}
    \caption{FM of a family of neural networks used to encode the MNIST1dataset, taken from \cite{Cazzola22cCazzola22c}}
