...
@TypeAnnotation(TypeEnum.FUNCTION)
@TypeLangAnnotation(keyword = "function", kind = TypeSystemKind.TYPE)
public class TypeFunction extends AbstractTypeFunction {
  ...
  @Override
  public Type withSymbolTableEntryFactory(
  ...
  @Override
  public Type withSymbolTableEntryFactory(
      Supplier<neverlang.core.typesystem.SymbolTableEntryFactory<?, ?>>
          symbolTableEntryFactorySupplier) {
