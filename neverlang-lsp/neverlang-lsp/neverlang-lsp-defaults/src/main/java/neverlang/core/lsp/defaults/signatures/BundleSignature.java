...
@SignatureAnnotation(SignatureEnum.BUNDLE)
@TypeLangAnnotation(keyword = "bundle", kind = TypeSystemKind.SIGNATURE)
public class BundleSignature implements Signature {}
