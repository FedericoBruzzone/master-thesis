...
\begin{frame}{\secname}
    % \framesubtitle{\subsecname}
    This could be achieved using a \alert{modular} approach and \\
    \alert{feature-oriented} programming.
\end{frame}
...
\begin{frame}{\secname}
    ...
    \begin{itemize}[itemsep=10pt]
        ...
        \item[\alert{-}] \alert{Client} and \alert{Syntax Highlighting} generation reducing to $\mathbf{N} \times \mathbf{1}$ the number of combinations.
